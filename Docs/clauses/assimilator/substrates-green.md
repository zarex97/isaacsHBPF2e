...
| EM-4a | Emerald D4 | **Fast healing 10.** |  | ☐ |  |
...
| ID | Guide | Clause | Static check | Status | Evidence |
| :-- | :-- | :-- | :-- | :-- | :-- |
| JA-1a | Jade D1 | +1 item bonus to Fortitude saves. |  | ☐ |  |
| JA-2a | Jade D2 | **Resistance 5** to poison. |  | ☐ |  |
| JA-2b | Jade D2 | You are immune to disease. |  | ☐ |  |
...
| JA-4b | Jade D4 | You cannot be **drained** or **enfeebled**. |  | ☐ |  |
...
| ID | Guide | Clause | Static check | Status | Evidence |
| :-- | :-- | :-- | :-- | :-- | :-- |
| ZN-1a | Zinc D1 | At daily preparations, choose one energy damage type. |  | ☐ |  |
| ZN-1b | Zinc D1 | Gain **resistance 2** to it. |  | ☐ |  |
| ZN-2a | Zinc D2 | **Resistance 5.** |  | ☐ |  |
...
| ID | Guide | Clause | Static check | Status | Evidence |
| :-- | :-- | :-- | :-- | :-- | :-- |
| CR-1a | Chromium D1 | Carapace **Hardness +2**. |  | ☐ |  |
| CR-1b | Chromium D1 | **Resistance 2** to acid. |  | ☐ |  |
...
| CR-4a | Chromium D4 | **Hardness +12**, **resistance 12** to acid. |  | ☐ |  |

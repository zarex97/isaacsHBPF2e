...
| ID | Guide | Clause | Static check | Status | Evidence |
| :-- | :-- | :-- | :-- | :-- | :-- |
| SR-05 | §5.1 | You gain the **Zanjutsu** feat |  | ✅ | Live at the boundary: the `Zanjutsu` feature is **absent at 4th** and present at 13th and 17th, publishing `soulbound:zanjutsu-access`. That option is what the §8.4 feat family is gated on, which is how "you gain the feat family" is said to a system that has no notion of one |
